...
export const workers: WorkerProfile[] = [
  {
    ...
    certifications: ["NCII Massage Therapy", "DOH Licensed"],
  ...
  },
  {
    ...
    hasBarangayClearance: true,
    certifications: ["Expert Nail Care Cert"],
    barangay: "Mankilam",
    completedJobs: 128,
  ...
  },
  {
    ...
    hasPoliceClearance: true,
    hasBarangayClearance: true,
    certifications: ["TESDA NCII Plumbing"],
    barangay: "Visayan Village",
    completedJobs: 89,
  ...
  },
  {
    ...
    certifications: ["TESDA NCII Electrical Installation"],
    barangay: "Apokon",
    completedJobs: 56,
  ...
  },
  {
    ...
    hasPoliceClearance: false,
    hasBarangayClearance: true,
    certifications: ["Housekeeping NCII"],
  ...
  },
  {
    ...
    hasPoliceClearance: true,
    hasBarangayClearance: true,
    certifications: ["Beauty Care NCII"],
    barangay: "Busaon",
    completedJobs: 112,
